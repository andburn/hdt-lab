...
{
    /*
     * Image tests at 1920x1080
     */
    [TestClass]
    public class ImageAnalyzerTestWideHigh
    {
        private const string Dir = @"Files\1920x1080\";
        ...
        [TestMethod]
        public void TestImage_Standard_1_1()
        {
            Assert.AreEqual(new CardCount(1, 1),
                ImageAnalyzer.Recognize(Dir + "standard_1_1.png"));
        }
        ...
        [TestMethod]
        public void TestImage_Standard_0_1()
        {
            Assert.AreEqual(new CardCount(0, 1),
                ImageAnalyzer.Recognize(Dir + "standard_0_1.png"));
        }
